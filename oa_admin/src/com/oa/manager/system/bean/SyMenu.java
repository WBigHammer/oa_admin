...
public class SyMenu implements java.io.Serializable {
	...
	public String toString() {
		return "SyMenu [id=" + id + ", menuSuperId=" + menuSuperId
				+ ", menuStatus=" + menuStatus + ", menuSort=" + menuSort
				+ ", menuName=" + menuName + ", menuIcon=" + menuIcon
				+ ", menuUrl=" + menuUrl + ", menuTarget=" + menuTarget
				+ ", menuRel=" + menuRel + ", menuOpen=" + menuOpen
				+ ", menuExternal=" + menuExternal + ", menuFresh=" + menuFresh
				+ "]";
	}
