...
<script type="text/javascript" src="resource/js/ui/masonry.pkgd.min.js"></script>
<%--日历视图 --%>
...
<%--拖拽功能---%>
<script src="resource/js/jquery.gridster.min.js" type="text/javascript"></script>
<link href='resource/css/jquery.gridster.min.css' rel='stylesheet' />

<%--base64功能--%>
<script type="text/javascript" src="resource/js/jbase64.js"></script>
<%--hightcharts组件--%>
