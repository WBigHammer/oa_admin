	...
	<table class="table table-bordered table-striped center">
		<thead>
			<tr>
				...
				<th width="60">打印</th>
				<%--<th width="60"  >显示</th>--%>
				<shiro:hasPermission name="tableCustom:update">
					<th width="50">操作</th>
				</shiro:hasPermission>
			...
			<c:forEach var="m" items="${requestScope.ts }">
				...
				<tr>
					...
					<td style="text-align: center;"><c:out
							value="${m.fieldTitle }" /></td>
					<td style="text-align: center;"><c:out
							value="${m.fieldAnotherTitle }" /></td>
					...
					<td style="text-align: center;"><c:choose>
							<c:when test="${m.isExport==1}">
								<img src="resource/images/small/Check_16x16.png" alt="是"
									title="是" style="margin-top: 2px;" />
							</c:when>
							<c:otherwise>
								<img src="resource/images/small/Delete_16x16.png" alt="否"
									title="否" style="margin-top: 2px;" />
							</c:otherwise>
						</c:choose></td>
					<td style="text-align: center;"><c:choose>
					...
					<shiro:hasPermission name="tableCustom:update">
						...
						<td style="text-align: center;"><a
							href="tableCustom/updatePage.do?id=${m.id }&rel=${param.rel}"
							target="dialog" width="800" height="400"
							rel="${param.rel}_update" title="修改导入导出设置">修改</a></td>
					</shiro:hasPermission>
